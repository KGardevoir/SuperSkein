...
class SSArea extends Area {
	...
	void setGridScale(float aGridScale){ GridScale = aGridScale; }
	float getGridScale(){ return GridScale; }

	void setHeadSpeed(float aHeadSpeed) { HeadSpeed = aHeadSpeed; }
	float getHeadSpeed() { return HeadSpeed; }

	void setFlowRate(float aFlowRate) { FlowRate = aFlowRate; }
